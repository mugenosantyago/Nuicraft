...
public class NuiRamaAnimator extends AzEntityAnimator<EntityNuiRama> {

    private static final ResourceLocation ANIMATIONS = ResourceLocation.fromNamespaceAndPath(
            NuiCraft.MODID, "animations/entity/nui-rama.animation.json");

    @Override
    public void registerControllers(AzAnimationControllerContainer<EntityNuiRama> container) {
    ...
    @Override
    public @NotNull ResourceLocation getAnimationLocation(EntityNuiRama entity) {
        return ANIMATIONS;
    }

    public static void sendMovementCommand(EntityNuiRama entity) {
    ...
    public static void sendAttackCommand(EntityNuiRama entity) {
