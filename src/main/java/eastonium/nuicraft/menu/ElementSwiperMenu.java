...
public class ElementSwiperMenu extends AbstractContainerMenu {
    ...
    static final Item[] TOA_STONES = {
            NuiCraftItems.FIRE_TOA_STONE.get(),
            NuiCraftItems.WATER_TOA_STONE.get(),
            NuiCraftItems.AIR_TOA_STONE.get(),
            NuiCraftItems.EARTH_TOA_STONE.get(),
            NuiCraftItems.ROCK_TOA_STONE.get(),
            NuiCraftItems.ICE_TOA_STONE.get()
    };
    ...
    public ElementSwiperMenu(int containerId, Inventory playerInventory) {
        super(NuiCraftRegistration.ELEMENT_SWIPER_MENU.get(), containerId);
    ...
    private static void consumeSwiper(Player player) {
        ...
        for (int i = 0; i < inv.getContainerSize(); i++) {
            ...
            if (s.is(NuiCraftItems.ELEMENT_SWIPER.get())) {
                s.shrink(1);
                return;
            }
        }
