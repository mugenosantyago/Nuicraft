...
public class EntityHoi extends Animal {
    
    public EntityHoi(EntityType<? extends EntityHoi> type, Level level) {
        super(type, level);
    }
    ...
    public net.minecraft.world.entity.AgeableMob getBreedOffspring(net.minecraft.server.level.ServerLevel level, net.minecraft.world.entity.AgeableMob otherParent) {
        return new EntityHoi(eastonium.mnogii.core.MnogiiEntityTypes.HOI.get(), level);
    }
}
