...
public class PurifierRecipeCategory implements IRecipeCategory<PurifyingRecipe> {
    ...
    public static final RecipeType<PurifyingRecipe> TYPE =
            RecipeType.create(Mnogii.MODID, "purifying", PurifyingRecipe.class);
    ...
    public PurifierRecipeCategory(IGuiHelper guiHelper) {
        ...
        this.icon = guiHelper.createDrawableItemStack(new ItemStack(MnogiiBlocks.PURIFIER.get()));
    }
    ...
    public Component getTitle() {
        return Component.translatable("block.mnogii.purifier");
    }
