...
public class BlockPureProtodermis extends ProtodermisFluidBlock {
    ...
    protected InteractionResult useItemOn(ItemStack stack, BlockState state, Level level, BlockPos pos,
        ...
        if (level.isClientSide) {
            for (int i = 0; i < 10; ++i) {
                level.addParticle(
                    new ItemParticleOption(ParticleTypes.ITEM, new ItemStack(MnogiiItems.NUGGET_PROTODERMIS.get())),
            ...
            ItemStack drop = new ItemStack(MnogiiItems.NUGGET_PROTODERMIS.get(), NUGGET_COUNT);
