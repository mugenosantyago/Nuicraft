...
public class MnogiiRegistration {
    public static final DeferredRegister<Fluid>              FLUIDS             = DeferredRegister.create(Registries.FLUID, Mnogii.MODID);
    public static final DeferredRegister<FluidType>          FLUID_TYPES        = DeferredRegister.create(NeoForgeRegistries.Keys.FLUID_TYPES, Mnogii.MODID);
    ...
    private static BaseFlowingFluid.Properties protoProps() {
        return new BaseFlowingFluid.Properties(TYPE_PROTODERMIS, SOURCE_PROTODERMIS, FLOWING_PROTODERMIS)
            .block(() -> (LiquidBlock) MnogiiBlocks.FLUID_PROTODERMIS.get())
            .bucket(() -> MnogiiItems.PROTODERMIS_BUCKET.get());
    }
    ...
    private static BaseFlowingFluid.Properties protoPureProps() {
        return new BaseFlowingFluid.Properties(TYPE_PROTODERMIS_PURE, SOURCE_PROTODERMIS_PURE, FLOWING_PROTODERMIS_PURE)
            .block(() -> (LiquidBlock) MnogiiBlocks.FLUID_PROTODERMIS_PURE.get())
            .bucket(() -> MnogiiItems.PURE_PROTODERMIS_BUCKET.get());
    }
    ...
    private static BaseFlowingFluid.Properties protoMoltenProps() {
        return new BaseFlowingFluid.Properties(TYPE_PROTODERMIS_MOLTEN, SOURCE_PROTODERMIS_MOLTEN, FLOWING_PROTODERMIS_MOLTEN)
            ...
            .block(() -> (LiquidBlock) MnogiiBlocks.FLUID_PROTODERMIS_MOLTEN.get())
            .bucket(() -> MnogiiItems.MOLTEN_PROTODERMIS_BUCKET.get());
    }
    ...
    private static BaseFlowingFluid.Properties protoPureMoltenProps() {
        return new BaseFlowingFluid.Properties(TYPE_PROTODERMIS_PURE_MOLTEN, SOURCE_PROTODERMIS_PURE_MOLTEN, FLOWING_PROTODERMIS_PURE_MOLTEN)
            .tickRate(40)
            .block(() -> (LiquidBlock) MnogiiBlocks.FLUID_PROTODERMIS_PURE_MOLTEN.get())
            .bucket(() -> MnogiiItems.PURE_MOLTEN_PROTODERMIS_BUCKET.get());
    }
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITY_TYPES = DeferredRegister.create(Registries.BLOCK_ENTITY_TYPE, Mnogii.MODID);
    public static final DeferredRegister<RecipeSerializer<?>> RECIPE_SERIALIZERS = DeferredRegister.create(Registries.RECIPE_SERIALIZER, Mnogii.MODID);
    public static final DeferredRegister<RecipeType<?>>      RECIPE_TYPES       = DeferredRegister.create(Registries.RECIPE_TYPE, Mnogii.MODID);
    public static final DeferredRegister<MenuType<?>>        MENU_TYPES         = DeferredRegister.create(Registries.MENU, Mnogii.MODID);
    ...
    public static final DeferredHolder<RecipeType<?>, RecipeType<PurifyingRecipe>> PURIFYING_TYPE =
            RECIPE_TYPES.register("purifying",
                    () -> RecipeType.simple(ResourceLocation.fromNamespaceAndPath(Mnogii.MODID, "purifying")));
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<PurifierBlockEntity>> PURIFIER_BE =
            BLOCK_ENTITY_TYPES.register("purifier", () ->
                    new BlockEntityType<>(PurifierBlockEntity::new, MnogiiBlocks.PURIFIER.get()));
